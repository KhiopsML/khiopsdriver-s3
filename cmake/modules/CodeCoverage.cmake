...
function(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
  ...
  add_custom_target(
    ...
    COMMAND ${LCOV_PATH} --directory . --capture --output-file
            ${_outputname}.info
    COMMAND
      ${LCOV_PATH} --remove ${_outputname}.info '*/build/*' '*/tests/*' '/usr/*'
      '*/vcpkg_installed/*' '*/_deps/*' --output-file
...
function(SETUP_TARGET_FOR_COVERAGE_COBERTURA _targetname _testrunner
  ...
  add_custom_target(
    ...
    # Running gcovr
    COMMAND
      ${GCOVR_PATH} -x -r ${CMAKE_SOURCE_DIR} -e '${CMAKE_SOURCE_DIR}/tests/' -e
      '${CMAKE_SOURCE_DIR}/build/' -o ${_outputname}.xml
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
